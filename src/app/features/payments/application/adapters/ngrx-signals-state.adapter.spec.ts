...
describe('NgRxSignalsStateAdapter', () => {
    ...
    describe('state signals delegation', () => {
        ...
        it('exposes intent from store', () => {
            const mockIntent = { id: 'pi_1', provider: 'stripe', status: 'succeeded', amount: 100, currency: 'MXN' };
    ...
    describe('fallback signals delegation', () => {
        ...
        it('exposes pendingFallbackEvent from store', () => {
            const mockEvent = { eventId: 'fb_1', failedProvider: 'stripe', alternativeProviders: ['paypal'] };
    ...
    describe('history signals delegation', () => {
        ...
        it('exposes lastHistoryEntry from store', () => {
            const mockEntry = { intentId: 'pi_1', provider: 'stripe', status: 'succeeded', amount: 100, currency: 'MXN', timestamp: Date.now() };
