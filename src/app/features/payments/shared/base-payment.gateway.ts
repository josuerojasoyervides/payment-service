...
import { CancelPaymentRequest, ConfirmPaymentRequest, CreatePaymentRequest, GetPaymentStatusRequest, PaymentError, PaymentIntent, PaymentProviderId } from "@payments/domain/models";
import { PaymentGateway } from "@payments/domain/ports";
import { catchError, map, Observable, tap, throwError } from "rxjs";

export abstract class BasePaymentGateway<TCreateDto = unknown, TConfirmDto = unknown> implements PaymentGateway {
