...
export type CreateIntentOp = PaymentGatewayOperation<
  ...
  PaymentIntent
>;
export type ConfirmIntentOp = PaymentGatewayOperation<
  ConfirmPaymentRequest,
  StripePaymentIntentDto,
  PaymentIntent
>;
export type CancelIntentOp = PaymentGatewayOperation<
  CancelPaymentRequest,
  StripePaymentIntentDto,
  PaymentIntent
>;
export type GetIntentStatusOp = PaymentGatewayOperation<
  GetPaymentStatusRequest,
  StripePaymentIntentDto,
  PaymentIntent
>;
