...
export class PaypalPaymentGateway extends PaymentGateway {
    ...
    protected confirmIntentRaw(req: ConfirmPaymentRequest): Observable<any> {
        return this.http.post('/api/payments/paypal/intents/confirm', req);
    }
    ...
    protected cancelIntentRaw(req: CancelPaymentRequest): Observable<any> {
        return this.http.post('/api/payments/paypal/intents/cancel', req);
    }
    ...
    protected getIntentRaw(req: GetPaymentStatusRequest): Observable<any> {
        return this.http.get(`/api/payments/paypal/intents/${req.intentId}`);
    }
