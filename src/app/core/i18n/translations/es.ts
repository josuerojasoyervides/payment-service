...
export const es: Translations = {
  errors: {
    ...
    rate_limited: 'Límite de solicitudes alcanzado. Espera e intenta de nuevo.',
    circuit_open: 'Proveedor temporalmente no disponible. Prueba otro proveedor.',
  ...
  ui: {
    ...
    circuit_open_title: 'Proveedor temporalmente no disponible',
    circuit_open_hint: 'El proveedor está en enfriamiento. Intenta con otro proveedor.',
    circuit_half_open_hint: 'Verificando disponibilidad del proveedor...',
    rate_limited_title: 'Demasiadas solicitudes',
    rate_limited_hint: 'Espera antes de intentar de nuevo.',
    manual_review_title: 'Revisión manual requerida',
    manual_review_hint:
      'No pudimos completar el pago automáticamente. Revisa en el panel del proveedor.',
    manual_review_action: 'Abrir panel del proveedor',
    all_providers_unavailable_title: 'Todos los proveedores no disponibles',
    all_providers_unavailable_hint: 'Intenta de nuevo más tarde.',
    health_checking: 'Verificando salud del proveedor...',
    health_available: 'Proveedor disponible',
    health_slow: 'Proveedor respondiendo lento',
    health_unavailable: 'Proveedor no disponible',
    unknown_error: 'Error desconocido',
