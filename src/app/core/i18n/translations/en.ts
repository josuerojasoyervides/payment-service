...
export const en: Translations = {
  errors: {
    ...
    circuit_open: 'Provider temporarily unavailable. Please try another provider.',
    ...
    order_id_too_long: 'orderId exceeds maximum length of {{max}} characters',
    order_id_invalid: 'orderId contains invalid characters',
    ...
    card_token_invalid_format: 'Invalid token format. Expected: {{expected}}. Got: {{got}}',
    intent_id_required: 'intentId is required',
    intent_id_too_long: 'intentId exceeds maximum length of {{max}} characters',
    intent_id_invalid: 'intentId contains invalid characters',
  ...
  ui: {
    ...
    fallback_in_progress_title: 'Switching payment method',
    fallback_in_progress_hint: 'Another payment method is being tried. You can cancel to stop.',
    fallback_auto_hint: 'An alternative payment method is being tried automatically.',
    circuit_open_title: 'Provider temporarily unavailable',
    circuit_open_hint: 'The provider is in a cooldown window. Please try another provider.',
    circuit_half_open_hint: 'Verifying provider availability...',
    rate_limited_title: 'Too many requests',
    rate_limited_hint: 'Please wait before trying again.',
    manual_review_title: 'Manual review required',
    manual_review_hint:
      'We could not complete the payment automatically. Review it in the provider dashboard.',
    manual_review_action: 'Open provider dashboard',
    all_providers_unavailable_title: 'All providers unavailable',
    all_providers_unavailable_hint: 'Please try again later.',
    health_checking: 'Checking provider health...',
    health_available: 'Provider available',
    health_slow: 'Provider responding slowly',
    health_unavailable: 'Provider unavailable',
    unknown_error: 'Unknown error',
    ...
    example_intent_placeholder: 'e.g. payment ID from your provider',
    ...
    debug_state_node: 'State node',
    debug_tags: 'Tags',
    debug_last_event_type: 'Last event type',
    debug_last_event_payload: 'Last event payload',
