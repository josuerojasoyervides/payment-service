...
export const en: Translations = {
    ...
    ui: {
        ...
        fallback_modal_info: 'This modal appears when a provider fails and alternatives are available. Allows the user to select another provider to retry the payment.',
